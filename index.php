...
<div class="container">
	...
	<!-- container -->
		...
		<i> <b> Join us today and get connected. Register now to get each and every updates of our college! </b></i>";
		}
		?>
  ...
  <div class="panel-heading"><b>Latest</b></div>
  <div class="panel-body">
    ... Hello.If you are new to "Online Notice Board" then "Sign Up" otherwise proceed by "Login"
  </div>
</div>
...
<!-- footer-->
  ...
  <ul class="nav navbar-nav navbar-left">
    <li><a href="about.php"> Brought To You By Sayali Bhosale </a></li>
